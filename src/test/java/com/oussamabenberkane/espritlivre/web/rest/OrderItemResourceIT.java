...
import static com.oussamabenberkane.espritlivre.domain.OrderItemAsserts.*;
...
import com.oussamabenberkane.espritlivre.repository.OrderItemRepository;
import com.oussamabenberkane.espritlivre.service.dto.OrderItemDTO;
import com.oussamabenberkane.espritlivre.service.mapper.OrderItemMapper;
...
class OrderItemResourceIT {
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.unitPrice(UPDATED_UNIT_PRICE);
