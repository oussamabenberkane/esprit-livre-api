...
import com.oussamabenberkane.espritlivre.security.*;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    // Public relay points (pickup points for guest checkout)
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/relay-points")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/relay-points/*")).permitAll()
